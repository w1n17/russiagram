...
import { getUserPosts, getSavedPosts } from "@/entities/post";
import { toggleFollow, checkIsFollowing } from "@/entities/follow/api";
...
import { getOrCreateConversation } from "@/entities/message/api";
...
export default function ProfilePage() {
  ...
  const isOwnProfile = Boolean(
    !userLoading && currentUser && profile && currentUser.id === profile.id
  );
        ...
        <div className="py-8 flex justify-center">
          <div className="w-full max-w-[935px] px-5">
            <div className="bg-white mb-11 px-5 py-11">
              <div className="flex items-start gap-7 md:gap-[90px] mb-16">
                <div className="flex-shrink-0 ml-5 md:ml-[70px] mb-8">
                  <Avatar
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                router.push(`/direct?id=${conversation.id}`);
                              } catch (error) {
            ...
            <div className="bg-white border-t border-[#dbdbdb] mt-8 mb-8">
              <div className="flex justify-center gap-16">
                <button
                  onClick={() => setActiveTab("posts")}
                  className={`flex items-center gap-1.5 py-[18px] ${
                    activeTab === "posts" ? "border-t border-black -mt-px" : ""
                  } text-xs font-semibold uppercase tracking-wider ${
                    activeTab === "posts" ? "" : "text-[#8e8e8e]"
                  }`}
                >
                  <Grid size={12} />
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 py-[18px] ${
                    activeTab === "saved" ? "border-t border-black -mt-px" : ""
                  } text-xs font-semibold uppercase tracking-wider ${
                    activeTab === "saved" ? "" : "text-[#8e8e8e]"
                  } hover:text-[#262626]`}
                >
                  <Bookmark size={12} />
            ...
            {activeTab === "posts" ? (
              ...
              <div className="bg-white flex flex-col items-center justify-center py-12">
                ...
                <p className="text-2xl font-light mb-2">
                  Сохранённых публикаций пока нет
                </p>
